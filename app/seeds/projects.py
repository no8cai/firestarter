...
def seed_projects():
     ...
     project7 = Project(creatorId=1, title='ALCHEMY: A FOUR PART DOCUSERIES', category='Film', city='Huntington Beach', state='California', country='USA',
