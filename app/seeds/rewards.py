...
def seed_rewards():
    ...
    reward2 = Reward(title="Reward 2 For Project 2", price="2.00", description="Includes a different reward. Wow!", projectId=2)
    reward3 = Reward(title="Reward 3 For Project 3", price="3.00", description="This reward is just feel-good fuzzies. Whoa!", projectId=3)
