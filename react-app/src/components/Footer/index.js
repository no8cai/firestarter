        ...
        <div className="footer-container">
            <div className="footer-links">
                <div className="footer-link-section">
                    ...
                    <p><a target="_blank"  href='https://github.com/no8cai/firestarter/wiki' className="footer-links-labels">ABOUT</a></p>
                </div>
                <div className="footer-link-section">
                    {/* <span className="footer-links-labels">SUPPORT</span> */}
                    <p><a target="_blank"  href='https://github.com/no8cai/firestarter/blob/main/README.md' className="footer-links-labels">SUPPORT</a></p>
                </div>
                <div className="footer-link-section">
                    {/* <span className="footer-links-labels">MORE FROM CLONESTARTER</span> */}
                    <p><a target="_blank"  href='https://www.kickstarter.com/' className="footer-links-labels">MORE ABOUT KICKSTARTER</a></p>
                </div>
            </div>
